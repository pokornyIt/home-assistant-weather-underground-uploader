"""Test upload button for Weather Underground Uploader."""
...
async def async_setup_entry(
    ...
    """Set up the test upload button for one station."""
    del hass
    async_add_entities([WeatherUndergroundTestUploadButton(entry)])
